...
//
// futharkiser CLI — GPU-accelerate array operations via Futhark
...
/// futharkiser — GPU-accelerate array operations via Futhark
#[derive(Parser)]
...
enum Commands {
    ...
    /// Generate Futhark wrapper, Zig FFI bridge, and C headers from the manifest.
    Generate {
        #[arg(short, long, default_value = "futharkiser.toml")]
        manifest: String,
